...
const shippmentCompanySchema = new mongoose.Schema({
...
const shippmentCompanyModel = mongoose.model("shippmentCompany", shippmentCompanySchema);

export default shippmentCompanyModel;
